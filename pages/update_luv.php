...
$pid = intval($_GET['nid']);
$ret = mysqli_query($con, "select Lov from tblposts where id='$pid'");
$row = mysqli_fetch_assoc($ret);
$nlk = $row['Lov'];
$lk = $nlk + 1;
$query = mysqli_query($con, "update tblposts  set Lov='$lk' where tblposts.id='$pid'");
...
?>
    ...
    <i class="fa fa-heart" style="font-size: 24px;color:#ff0000;"><span> <?php echo htmlentities($us['Lov']); ?></span></i>
