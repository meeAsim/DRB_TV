            ...
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <div class="single_sidebar">
                        ...
                        <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fdrbtelevision%2F&tabs=timeline&width=500&height=500&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="100%" height="360" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <aside class="right_content">
                        ...
                        <div class="single_sidebar wow fadeInDown">
                            <?php
                            $qry = mysqli_query($con, "select Picture from tblads where id = 11");
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="photograph_nav wow fadeInDown">
                                ...
                                $query = mysqli_query($con, "select * from tblvideos LIMIT $offset, $no_of_records_per_page");
                                while ($row = mysqli_fetch_array($query)) {
                                ...
                                ?>
                                    ...
                                    <li>
                                        <figure class="bsbig_fig wow fadeInDown">
                                            ...
                                            <figcaption>
                                                <a href="uvideos.php?vid=<?php echo htmlentities($row['id']) ?>>"><?php echo htmlentities($row['heading']); ?>"</a>
                                            </figcaption>
            ...
            <section class="banner add">
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-6">
                            <?php
                            $qry2 = mysqli_query($con, "select Picture from tblads where id = 12");
                        ...
                        <div class="col-md-6">
                            <?php
                            $qry3 = mysqli_query($con, "select Picture from tblads where id = 13");
