    ...
    <div class="container">
        ...
        <section id="sliderSection">
            <div class="row">
                ...
                $total_pages_sql = "SELECT COUNT(*) FROM tblblog";
                $result = mysqli_query($con, $total_pages_sql);
                $total_rows = mysqli_fetch_array($result)[0];
                $total_pages = ceil($total_rows / $no_of_records_per_page);

                $qy = mysqli_query($con, "select * from tblblog  order by id desc LIMIT $offset, $no_of_records_per_page");
                while ($rw = mysqli_fetch_array($qy)) {

                ?> <div class="col-md-4">
                        <figure class="bsbig_fig">
                            <a href="details.php?nid=<?php echo htmlentities($rw['id']); ?>" class="featured_img">
                                <img alt="" src="../admin/blogimages/<?php echo htmlentities($rw['PostImage']); ?>" style="height: 150px;" />
                                <span class="overlay"></span>
                            </a>
                            <figcaption>
                                <a href="blogs.php?nid=<?php echo htmlentities($rw['id']); ?>"><?php echo htmlentities($rw['PostTitle']); ?></a>
                            </figcaption>
