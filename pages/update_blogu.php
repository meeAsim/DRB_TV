...
$pid = intval($_GET['nid']);
$ret = mysqli_query($con, "select Unlke from tblblog where id='$pid'");
$row = mysqli_fetch_assoc($ret);
$nlk = $row['Unlke'];
$lk = $nlk + 1;
$query = mysqli_query($con, "update tblblog  set Unlke='$lk' where tblblog.id='$pid'");
...
?>
    ...
    <i onclick="myFunction2(this)" id="colll" class="fa fa-thumbs-down" style="font-size: 24px;color:#0066ff;"><span> <?php echo htmlentities($us['Unlke']); ?></span></i>
