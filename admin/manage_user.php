...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($con, "update tbladmin set Is_Active='$val' where id='$aid'");
        if ($query) {
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <table id="example2" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $qr = mysqli_query($con, "select * from tbladmin");
                                                $num = 1;
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?php echo $num; ?></td>
                                                        <td><?php echo htmlentities($row['AdminUserName']); ?>
                                                        </td>
                                                        ...
                                                        ?>
                                                            <form method="POST">
                                                                ...
                                                                <td>
                                                                    <button type="submit" class="btn btn-danger" name="submit">Make Inactive</button>
                                                                </td>
                                                            </form>
                                                        <?php } else {
                                                        ?> <form method="POST">
