                            ...
                            <form name="addpost" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="posttitle" name="location" placeholder="Enter location" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="posttitle" name="source" placeholder="Source of the news" required>
                                    </div>
