...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $qry = mysqli_query($con, "select PostImage from tblblog where id = '$pid'");
        $rw = mysqli_fetch_array($qry);


        unlink("blogimages/" . $rw['PostImage']);
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            $query = mysqli_query($con, "update tblblog set PostImage='$imgnewfile' where id='$postid'");
            if ($query) {
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <form name="addpost" method="post" enctype="multipart/form-data">
                                <?php
                                $postid = intval($_GET['pid']);
                                $query = mysqli_query($con, "select PostImage,PostTitle from tblblog where id='$postid' and Is_Active=1 ");
