...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            $status = 1;
            $user = $_SESSION['login'];
            $query = mysqli_query($con, "insert into tblads(Title,Picture,Discription,User) values('$name','$imgnewfile','$des','$user')");
            if ($query) {
                                    ...
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                                $user = $_SESSION['login'];
                                                $qr = mysqli_query($con, "select * from tblads");
                                                $num = 1;
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="ads/<?php echo htmlentities($row['Picture']); ?>" alt="picture" style="width:150px; height:80px;" />
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a href="update_ads.php?rid=<?php echo htmlentities($row['id']); ?>&&action=update" class="btn btn-warning">Update</a>
                                                        </td>
