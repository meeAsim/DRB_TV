        ...
        <section id="sliderSection">
            <div class="row">
                ...
                <div class="single_post_content">
                    ...
                    //search code//
                    $query = mysqli_query($con, "select tblposts.id as pid,tblposts.PostImage as image,tblposts.PostTitle as posttitle,tblcategory.CategoryName as category,tblsubcategory.Subcategory as subcategory,tblposts.PostDetails as postdetails,tblposts.PostingDate as postingdate,tblposts.PostUrl as url from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join  tblsubcategory on  tblsubcategory.SubCategoryId=tblposts.SubCategoryId where tblposts.PostTitle like '%$st%' and tblposts.Is_Active=1 LIMIT $offset, $no_of_records_per_page");

                    $rowcount = mysqli_num_rows($query);
                    if ($rowcount == 0) {
                        echo "तपाइँको खोजको लागि केहि फेला परेन फेरि प्रयास गर्नुहोस्";
                    } else {
                        while ($row = mysqli_fetch_array($query)) {
                    ...
                    ?>
                            ...
                            <div class="col-md-4">
                                <figure class="bsbig_fig">
                                    <a href="pages/details.php?nid=<?php echo htmlentities($row['pid']); ?>" class="featured_img">
                                        <img alt="" src="admin/postimages/<?php echo htmlentities($row['image']); ?>" />
                                        <span class="overlay"></span>
                                    </a>
                                    <figcaption>
                                        <a href="pages/details.php?nid=<?php echo htmlentities($row['pid']); ?>"><?php echo htmlentities($row['posttitle']); ?></a>
